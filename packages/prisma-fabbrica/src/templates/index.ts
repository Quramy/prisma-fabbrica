          ...
          ast.propertySignature(
            ...
            ast.unionTypeNode([
              ...((field.isRequired || model.fields.find(byName(field))!.isList === false) &&
                isInputObjectTypeField(field) && findPrismaCreateInputTypeFromModelName(document, model.fields.find(byName(field))!.type)
    ...
    ...document.datamodel.models
      ...
      .flatMap(({ model, createInputType }) => [
        ...
        ...filterBelongsToField(model, createInputType)
          .filter(fieldType => findPrismaCreateInputTypeFromModelName(document, model.fields.find(byName(fieldType))!.type) !== null)
          .map(fieldType =>
